...
const Services=forwardRef(({ }, ref1) =>{
    ...
    return(
    <>
    <div ref={ref1} className='relative sm:max-[425px]:mt-14'>
    ...
    <div className='p-8 sm:max-[425px]:p-2 w-[80%] sm:max-[425px]:w-[100%] mx-auto grid grid-cols-2 sm:max-[425px]:grid-cols-1'>
        <div >
            <div className='h-[20vh] sm:max-[425px]:h-[3vh]'>
   ...
   < motion.p initial={{x:-150,opacity:0}} whileInView={{x:0,opacity:1, transition: { duration: 0.6 }}} className='text-white sm:max-md:w-[80%] sm:max-md:text-[7px]  font-Livvic my-2 md:max-lg:w-[70%] text-[12px] w-[50%]'>
    ...
    <motion.div initial={{opacity:0}} whileInView={{opacity:1, transition:{duration:1}}} style={{backgroundImage: `linear-gradient(to right,rgba(0,0,0,0.9), rgba(0,0,0,0.5)), url(${require('../assets/services1.png')})`}} className='w-[350px] sm:max-md:w-[175px] sm:max-md:h-[250px] md:max-lg:w-[250px] md:max-lg:h-[350px] bg-cover bg-center mt-[15%] sm:max-[425px]:w-[100%] sm:max-md:mt-[55%] h-[400px]'></motion.div>
    </div>

    <div className='w-[50%] sm:max-[425px]:w-[100%] sm:max-[425px]:mx-0 sm:max-md:flex sm:max-md:flex-col sm:max-[425px]:mt-24 gap-24 sm:max-[425px]:gap-0 mx-auto'>
        <motion.div initial={{opacity:0}} whileInView={{opacity:1, transition:{duration:1}}} style={{backgroundImage: `linear-gradient(to right,rgba(0,0,0,0.9), rgba(0,0,0,0.5)), url(${require('../assets/services5.png')})`}} className='w-[350px] sm:max-md:w-[175px] sm:max-md:h-[250px] sm:max-[425px]:w-[100%]  md:max-lg:w-[250px] md:max-lg:h-[350px] bg-cover bg-center mt-[-10%] h-[400px]'></motion.div>
    
    <motion.div initial={{opacity:0}} whileInView={{opacity:1, transition:{duration:1}}} style={{backgroundImage: `linear-gradient(to right,rgba(0,0,0,0.9), rgba(0,0,0,0.5)), url(${require('../assets/services2.png')})`}} className='w-[350px] sm:max-md:w-[175px] sm:max-md:h-[250px] sm:max-[425px]:w-[100%] md:max-lg:mt-44 md:max-lg:w-[250px] md:max-lg:h-[350px] bg-cover bg-center mt-[20%] h-[400px]'></motion.div>
