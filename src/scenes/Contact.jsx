...
import emailjs from 'emailjs-com';
 ...
 const Contact=forwardRef(({},ref)=>{
  ...
  const handleChange = (e) => {
    ...
    return(
        <>
        <motion.div ref={ref}  className='w-full   bg-gray-100 min-h-[100vh] lg:max-xl:min-h-[120vh] max-h-[120vh]'>
        <div className='w-full sm:max-md:w-[80%] '>
    ...
    <div className='w-full grid grid-cols-2 sm:max-md:grid-cols-1'>
      ...
      {({ inView, ref }) => (
        ...
        <div className='w-[60%] md:max-lg:w-[70%] sm:max-md:w-[80%] mx-auto'>
            <p className='text-[1.5rem] font-bold mx-16 font-Abel '> Fill-out Form</p>
      ...
      {emailError && <p className="text-red-500">{emailError}</p>}
       ...
       <button onClick={sendEmail} className='mx-16 font-Lexend text-md text-emerald-700 p-2  mt-8 border-2 border-emerald-600 rounded-sm hover:bg-emerald-600 hover:text-white'>Send Message</button>
